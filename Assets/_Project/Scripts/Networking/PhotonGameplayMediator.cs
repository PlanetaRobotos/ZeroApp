...
namespace _Project.Scripts.Networking
{
    public class PhotonGameplayMediator : INetworkRunnerCallbacks, IGameplayMediator
    {
        ...
        public async UniTask StartGame()
        {
            ...
            var searchOpponentWindow = await WindowsController.OpenWindowAsync<SearchOpponentWindow>(
            ...
            while (searchOpponentTimer < WaitingOpponentDelay && Object.FindObjectsOfType<NetworkPlayerHandler>().Length < 2)
            {
                var delay = 0.2f;
            ...
            var players = Object.FindObjectsOfType<NetworkPlayerHandler>();
            if (players.Length == 2)
            {
                _players = players;
        ...
        private async UniTask BothPlayersAreJoinedAsync()
        {
            ...
            _players[0].StartGame(SymbolType.Cross, isInteractable: true);
            _players[1].StartGame(SymbolType.Circle, isInteractable: false);
        }
